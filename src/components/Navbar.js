...
const Navbar = () => {
  const [condition, setBtnState] = useState(false);

  return (
    <nav className="flex w-full lg:w-full items-center justify-between flex-wrap bg-transparent absolute p-6 ">
      <div className="flex items-center flex-shrink-0 text-white mr-6">
        ...
        &nbsp;
        <span className="font-semibold text-xl tracking-tight">Maxxoto</span>
      </div>
      <div className="block lg:hidden">
        <button onClick={() => setBtnState(!condition)} className="flex items-center px-3 py-2 border rounded text-teal-200 border-teal-400 hover:text-white hover:border-white">
          <svg className="fill-current h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" /></svg>
        </button>
      </div>
      <div className="block w-full lg:w-auto lg:ml-auto lg:flex lg:items-center ">
        <div className={`${condition ? 'collapse' : 'collapse-hidden'} text-sm lg:flex-grow `} >


          <NavLink to="/" className="block mt-4 mr-8 lg:inline-block sm:mt-0 lg:mt-0 text-white hover:text-teal-600">Home</NavLink>
          <NavLink to="/skills" className="block mt-4 mr-8 lg:inline-block sm:mt-0 lg:mt-0 text-white hover:text-teal-600">Skills</NavLink>
          <NavLink to="/experiences" className="block mt-4 mr-8 lg:inline-block sm:mt-0 lg:mt-0 text-white hover:text-teal-600">Experiences</NavLink>
          <NavLink to="/traits" className="block mt-4 mr-8 lg:inline-block sm:mt-0 lg:mt-0 text-white hover:text-teal-600">Traits</NavLink>
          <NavLink to="/projects" className="block mt-4 mr-8 lg:inline-block sm:mt-0 lg:mt-0 text-white hover:text-teal-600">Projects</NavLink>
        </div>
